  ...
  return (
    <div>
      <MotionDivDownToUp>
        <div
          id="cardBlog"
          className="w-[290px] phone2:w-[300px] phone3:w-[350px] tablet1:w-[400px] tablet2:w-[210px] font-mainFont flex flex-col desktop1:max-w-[285px] desktop3:max-w-[375px] shadow-custom-opacity shadow-shadowBlogs/30 bg-bgSectionLight rounded-2xl p-[20px]"
        >
